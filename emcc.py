  ...
  try:
    ...
    if shared.Settings.BINARYEN:
      ...
      if js_opts and not force_js_opts and 'asmjs' not in shared.Settings.BINARYEN_METHOD:
        js_opts = None
        logging.debug('asm.js opts not forced by user or an option that depends them, and asm.js is a binaryen method, so disabling and leaving opts to the binaryen optimizer')
      if use_closure_compiler:
